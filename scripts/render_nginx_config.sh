...
envsubst '${DASHBOARD_HTTPS_PORT} ${DASHBOARD_SERVER_NAME} ${DASHBOARD_TLS_CERTIFICATE} ${DASHBOARD_TLS_PRIVATE_KEY} ${DASHBOARD_FRONTEND_UPSTREAM} ${DASHBOARD_BACKEND_UPSTREAM}' \
  < "$TEMPLATE" > "$OUTPUT"
