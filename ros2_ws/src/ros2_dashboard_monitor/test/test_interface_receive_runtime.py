...
def test_topic_receive_history_limit_and_stop(monkeypatch):
    ...
    monkeypatch.setattr(
        'ros2_dashboard_monitor.interface_lab.execution.topic_runtime.get_message',
...
def _registered_message(monkeypatch, extra_type=None):
    ...
    monkeypatch.setattr(
        'ros2_dashboard_monitor.interface_lab.execution.topic_runtime.registry_snapshot',
        lambda: {'interface_registry': {'messages': messages}},
    )
    monkeypatch.setattr(
        'ros2_dashboard_monitor.interface_lab.execution.topic_runtime.registered_package_messages',
        lambda: [],
    )
